...
function isClickOnThumb(e) {
  ...
  if (isVertical(slider)) {
    ...
    // 🔹 Limita la zona “cliccabile” solo alla metà sinistra della track
    const maxClickableX = rect.left + rect.width * 0;
    if (x > maxClickableX) return false;
